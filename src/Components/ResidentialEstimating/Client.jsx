...
const Client = () => {
  return (
    <div className="testimonials-wrapper">
      <h2 className="testimonials-heading">WHAT CLIENTS ARE SAYING <br/>ABOUT US</h2>
      <div className="testimonials-cards">
        {testimonials.map((testimonial, index) => (
          <div className={`testimonial-card testimonial-card-${index + 1}`} key={index}>
            <div className={`testimonial-bg-shape testimonial-bg-shape-${index + 1}`}></div>
