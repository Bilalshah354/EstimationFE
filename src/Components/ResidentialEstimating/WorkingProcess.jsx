          ...
          <div className="process-steps">
            <div className="step active">
              ...
              <div className="step-details">
                ...
                <p>Every project begins with a thorough consultation. We take the time to understand your specific needs, project scope, and objectives. This allows us to tailor our services to meet your unique requirements.</p>
              </div>
            </div>
            <div className="step">
        ...
        <div className="process-right">
          <div className="process-description">
            <p className="delivery-heading">
              How We Deliver <span className="working-highlight">Accurate Residential Estimates?</span>
            </p>
            <p className="delivery-text">
              Our process is designed to deliver accurate and reliable estimates that you can trust. Here's how we do it:
            </p>
          </div>
          ...
          <div className="process-images">
            ...
            <div className="left-column">
              <img src={buildingImg} alt="Building under construction" className="image" />
            </div>
          </div>
        </div>
      </div>
